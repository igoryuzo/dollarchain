  ...
  return (
    <div className="text-center mb-8">
      <div className="flex items-center justify-center space-x-5">
        <div className="px-4 py-1 font-medium text-[#00C853] text-base">
          {count} players on waitlist
        </div>
        
        {shared ? (
          <div className="inline-flex items-center px-3 py-2 rounded-md text-sm bg-[#00C853] text-white">
          ...
          <button
            onClick={handleShare}
            disabled={isSharing}
            className="inline-flex items-center px-5 py-2 text-sm font-medium rounded-md text-white bg-[#00C853] hover:bg-opacity-90 focus:outline-none transition-colors"
          >
            {isSharing ? "..." : "Share"}
          </button>
        )}
